...
class SignUpTest(unittest.TestCase):
    ...
    def test_New_SignUp(self):
        ...
        logging.info("********Entering Last Name*********")
        signUp.enter_Email_Address(TestData.NemailId)
        logging.info("********Entering Email Id *********")
        ...
        try:   
            ...
            textSucessMessage = self.driver.find_element(By.XPATH,"//div[@class='form-section']/h1[@class='w-90']").text
            print(textSucessMessage)
            
            if self.assertEqual(textSucessMessage.text,"Account created successfully"):
